...
public:
  ...
  void setReportSenderSSRC(unsigned reportSenderSSRC) {freportSenderSSRC = reportSenderSSRC;}
  unsigned getReportSenderSSRC() const {return freportSenderSSRC;}
protected:
